...
-----
   ...
   * movies.dat
   	...
   	has been extended with public data provided in IMDb and Rotten Tomatoes websites:
   	   ...
   	   - IMDb picture URLs
           ...
           - Rotten Tomatoes all critics' ratings, avg. scores, numbers of reviews/fresh_scores
   ...
   * movie_actors.dat
   	    ...
   	    This file contains the main actors and actresses of the movies.
   ...
   * user_taggedmovies.dat
        ...
        This file contains the tag assignments of the movies provided by each particular user.
...
-----------
   ...
   * movie_ratings.dat
        id \t rtAllCriticsRating \t rtAllCriticsNumReviews \t rtAllCriticsNumFresh \t rtAudienceRating \t rtAudienceNumRatings \t rtAudienceScore

        Example:
        1   9	73	73	100 100	3.7	102338	81
