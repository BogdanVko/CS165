            ...
            while (scan.hasNextLine()) {
                ...
                switch (fields[0]) {
                    ...
                    case "POLYGON":
                    	...
                    	for(int x = 4, i = 0; x < fields.length; i++, x++) {
                    		if(x % 2 == 0 ) {
                    			
                    			xPoints[i] = Integer.parseInt(fields[x]);
                    		}else {
                    			i--;
                    		}
                    	}	
                    	...
                    	for(int x = 4, i = 0; x < fields.length; i++, x++) {
                    		if(x % 2 != 0 ) {
                    			...
                    			yPoints[i] = Integer.parseInt(fields[x]);
                    		}else {
                    			i--;
                    		}
                    	}	
                    	...
                    	Polygon p= new Polygon(xPoints, yPoints);
                    	
                        p.setColor(Integer.parseInt(fields[1],16));
                        p.setFilled(fields[2].equals("filled"));
                        primitives.add(p);
                        break;
